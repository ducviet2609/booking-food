            ...
            <div className="cart_product_info d-flex align-items-center justify-content-between gap-4 w-100">
                <div>
                    ...
                    <div className='change_product_btn d-flex align-items-center justify-content-between gap-3'>
                        ...
                        <span className='increase_btn' onClick={increaseItem}><i class="ri-add-fill"></i></span>

                    </div>
                    
                </div>

                <span className='product_delete_btn' onClick={deleteItem}> <i class="ri-close-fill"></i></span>
            </div>
        </div>
    </ListGroupItem>
  )
